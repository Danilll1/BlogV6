        ...
        <section class="content">
            ...
            <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('title') is-invalid @enderror" id="description"
                                name="description" placeholder="Цитата ...">
                          </div>


                <div class="form-group">
                    <label for="content">Контент</label>
                    <textarea class="form-control @error('title') is-invalid @enderror" id="content" name="content" placeholder="Контент ...">
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="select2" id="tags" name="tags[]" data-placeholder="Выбор тегов ..." style="width: 100%">
                  @foreach ($tags as $k => $v)
                  <option value="{{ $k }}">{{ $v }}</option>
                  @endforeach
                  </select>
